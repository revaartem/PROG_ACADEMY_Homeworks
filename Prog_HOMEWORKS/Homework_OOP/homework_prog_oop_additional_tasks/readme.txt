...
1. Create a class that performs statistical processing of a text file -
counting characters, words, sentences, etc. Determine the required attributes-data
and attributes-methods in class for working with the text file.

.task_1

2. Pizzeria offers pizza-of-the-day for business lunch. The type of pizza-of-the-day
